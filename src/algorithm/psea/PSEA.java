...
//		exactShrinkHyperplane();
	...
	private void exploit() {
		...
		do{
			...
			double nearestLambda = ASFBundle.getInstance().getAsfDMs().stream().mapToDouble(lambda -> Geometry.euclideanDistance(lambda.getLambda(), DMranker.getLambda())).min().getAsDouble();
