...
//			problems.add(new WFG7(no));
		...
		executionParametersMap.put(new Pair<String, Integer>("DTLZ1", 3), new ExecutionParameters(92, 400, 150, 150, 50, 30, elicInter, numLambdaDirections, spreadThresh));
		executionParametersMap.put(new Pair<String, Integer>("DTLZ1", 5), new ExecutionParameters(212, 600, 200, 200, 50, 30, elicInter, numLambdaDirections, spreadThresh));
		executionParametersMap.put(new Pair<String, Integer>("DTLZ1", 8), new ExecutionParameters(156, 750, 300, 300, 50, 30, elicInter, numLambdaDirections, spreadThresh));
...
//		executionParametersMap.put(new Pair<String, Integer>("DTLZ1", 15), new ExecutionParameters(136, 1500, numExplor, numExploit, numElic1, numElic2, elicInter, numLambdas, spreadThresh))
		...
		executionParametersMap.put(new Pair<String, Integer>("DTLZ2", 3), new ExecutionParameters(92, 250, numExplor, numExploit, numElic1, numElic2, elicInter, numLambdaDirections, spreadThresh));
		executionParametersMap.put(new Pair<String, Integer>("DTLZ2", 5), new ExecutionParameters(212, 350, numExplor, numExploit, numElic1, numElic2, elicInter, numLambdaDirections, spreadThresh));
		executionParametersMap.put(new Pair<String, Integer>("DTLZ2", 8), new ExecutionParameters(156, 500, numExplor, numExploit, numElic1, numElic2, elicInter, numLambdaDirections, spreadThresh));
...
//		executionParametersMap.put(new Pair<String, Integer>("DTLZ2", 15), new ExecutionParameters(136, 1000, numExplor, numExploit, numElic1, numElic2, elicInter, numLambdas, spreadThresh))
		...
		executionParametersMap.put(new Pair<String, Integer>("DTLZ3", 3), new ExecutionParameters(92, 1000, numExplor, numExploit, numElic1, numElic2, elicInter, numLambdaDirections, spreadThresh));
		executionParametersMap.put(new Pair<String, Integer>("DTLZ3", 5), new ExecutionParameters(212, 1000, numExplor, numExploit, numElic1, numElic2, elicInter, numLambdaDirections, spreadThresh));
		executionParametersMap.put(new Pair<String, Integer>("DTLZ3", 8), new ExecutionParameters(156, 1000, numExplor, numExploit, numElic1, numElic2, elicInter, numLambdaDirections, spreadThresh));
...
//		executionParametersMap.put(new Pair<String, Integer>("DTLZ3", 15), new ExecutionParameters(136, 2000, numExplor, numExploit, numElic1, numElic2, elicInter, numLambdas, spreadThresh))
		...
		executionParametersMap.put(new Pair<String, Integer>("DTLZ4", 3), new ExecutionParameters(92, 600, numExplor, numExploit, numElic1, numElic2, elicInter, numLambdaDirections, spreadThresh));
		executionParametersMap.put(new Pair<String, Integer>("DTLZ4", 5), new ExecutionParameters(212, 1000, numExplor, numExploit, numElic1, numElic2, elicInter, numLambdaDirections, spreadThresh));
		executionParametersMap.put(new Pair<String, Integer>("DTLZ4", 8), new ExecutionParameters(156, 1250, numExplor, numExploit, numElic1, numElic2, elicInter, numLambdaDirections, spreadThresh));
...
//		executionParametersMap.put(new Pair<String, Integer>("DTLZ4", 15), new ExecutionParameters(136, 3000, numExplor, numExploit, numElic1, numElic2, elicInter, numLambdas, spreadThresh))
		...
		executionParametersMap.put(new Pair<String, Integer>("WFG1", 2), new ExecutionParameters(92, 400, 100, 100, numElic1, numElic2, elicInter, numLambdaDirections, spreadThresh));
		executionParametersMap.put(new Pair<String, Integer>("WFG1", 3), new ExecutionParameters(92, 400, 150, 150, numElic1, numElic2, elicInter, numLambdaDirections, spreadThresh));
		executionParametersMap.put(new Pair<String, Integer>("WFG1", 5), new ExecutionParameters(212, 750, 200, 200, numElic1, numElic2, elicInter, numLambdaDirections, spreadThresh));
		executionParametersMap.put(new Pair<String, Integer>("WFG1", 8), new ExecutionParameters(156, 1500, 300, 300, numElic1, numElic2, elicInter, numLambdaDirections, spreadThresh));
		
		executionParametersMap.put(new Pair<String, Integer>("WFG6", 2), new ExecutionParameters(92, 400, 100, 100, numElic1, numElic2, elicInter, numLambdaDirections, spreadThresh));
		executionParametersMap.put(new Pair<String, Integer>("WFG6", 3), new ExecutionParameters(92, 400, 150, 150, numElic1, numElic2, elicInter, numLambdaDirections, spreadThresh));
		executionParametersMap.put(new Pair<String, Integer>("WFG6", 5), new ExecutionParameters(212, 750, 200, 200, numElic1, numElic2, elicInter, numLambdaDirections, spreadThresh));
		executionParametersMap.put(new Pair<String, Integer>("WFG6", 8), new ExecutionParameters(156, 1500, 300, 300, numElic1, numElic2, elicInter, numLambdaDirections, spreadThresh));
		
		executionParametersMap.put(new Pair<String, Integer>("WFG7", 2), new ExecutionParameters(92, 400, 100, 100, numElic1, numElic2, elicInter, numLambdaDirections, spreadThresh));
		executionParametersMap.put(new Pair<String, Integer>("WFG7", 3), new ExecutionParameters(92, 400, 150, 150, numElic1, numElic2, elicInter, numLambdaDirections, spreadThresh));
		executionParametersMap.put(new Pair<String, Integer>("WFG7", 5), new ExecutionParameters(212, 750, 200, 200, numElic1, numElic2, elicInter, numLambdaDirections, spreadThresh));
		executionParametersMap.put(new Pair<String, Integer>("WFG7", 8), new ExecutionParameters(156, 1500, 300, 300, numElic1, numElic2, elicInter, numLambdaDirections, spreadThresh));
	}
}