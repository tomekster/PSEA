...
//                System.out.println("skipping line: comment");
	...
	public int getTempNumDimensions() {
		return tempNumDimensions;
	}

	public void setTempNumDimensions(int tempNumDimensions) {
		this.tempNumDimensions = tempNumDimensions;
	}
	...
	public void setIsStringLabel(boolean array[]){
		isStringLabel = array;
	}
}
