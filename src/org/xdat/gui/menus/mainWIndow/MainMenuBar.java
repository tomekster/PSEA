...
public class MainMenuBar extends JMenuBar {
	...
	/** Help menu. */
	private MainNSGAIIIMenu mainNSGAIIIMenu;
	...
	public MainMenuBar(Main mainWindow) {
		...
		this.mainNSGAIIIMenu = new MainNSGAIIIMenu(mainWindow);
	...
	/**
	 * Tells the main menu bar whether the {@link org.xdat.org.xdat.data.DataSheet} is
