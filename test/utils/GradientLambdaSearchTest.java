...
//		GradientLambdaSearch gls = new GradientLambdaSearch(3);
// 		ArrayList < Pair<Double, Integer> > switchPoints = gls.getAllSwitchPoints(asfBundle, lambda1, lambda2);
...
//		ArrayList <Interval> intervals = gls.findBestIntervals(asfBundle, switches, l1, l2);
...
//		AsfPreferenceModel middle = new AsfPreferenceModel(dim);
