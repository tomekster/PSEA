...
public class NonDominatedSortTest {
	...
	public void oneSolutionPopulationTest() {
		...
		s1 = new DoubleSolution(var1,obj1);
		p.addSolution(s1);
	...
	public void twoSolutionsTwoFrontsTest() {
		...
		s1 = new DoubleSolution(var1,obj1);
		s2 = new DoubleSolution(var2,obj2);
	...
	public void manyFrontsTest() {
		DoubleSolution s1, s2, s3, s4, s5, s6, s7;
		...
		s1 = new DoubleSolution(var1,obj1);
		s2 = new DoubleSolution(var2,obj2);
		s3 = new DoubleSolution(var3,obj3);
		s4 = new DoubleSolution(var4,obj4);
		s5 = new DoubleSolution(var5,obj5);
		s6 = new DoubleSolution(var6,obj6);
		s7 = new DoubleSolution(var7,obj7);
