...
public class PopulationTest {
	...
	public void populationTest(){
			...
			pop.addSolution(new DoubleSolution(var1,obj));
			pop.addSolution(new DoubleSolution(var2,obj));
			pop.addSolution(new DoubleSolution(var3,obj));
			pop.addSolution(new DoubleSolution(var4,obj));
