...
public class NicheCountSelectionTest {
	...
	public void normalizeTest(){
		...
		double obj3[] = {6,4};
		double obj4[] = {10,2};
		allFronts.addSolution(new DoubleSolution(var, obj1));
		allFronts.addSolution(new DoubleSolution(var, obj2));
		allFronts.addSolution(new DoubleSolution(var, obj3));
		allFronts.addSolution(new DoubleSolution(var, obj4));
